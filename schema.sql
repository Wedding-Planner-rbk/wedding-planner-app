...
INSERT into flowers (name,imageUrl,description,price,provider_id) VALUES ("Arrangements","https://i2.wp.com/yorkshiredalesflowers.co.uk/wp-content/uploads/2016/06/YDFC-British-34.jpg?fit=668%2C1000&ssl
...
INSERT into packages (hall_id,flowers_id,cakes_id,music_id, name , description,price,image_url) VALUES (6,6,6,6, "Traditional", "Anthropology. the primary established form of marriage recognized in a given country or religious or social group at a given time: In that culture, traditional marriage requires the families of the future bride and groom to engage in ritual visits and exchange gifts.", 12000,'https://cdn.face2faceafrica.com/www/wp-content/uploads/2017/06/tunisian-768x512.jpg');
